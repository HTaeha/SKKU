...
rbt_tree *rbt_create();	
// (1) create and initialize rbt_tree 
//(2) return created rbt_tree
rbt_node *insert(rbt_tree *T, int key);			
// (1) create and initialize rbt_node 
//(2) insert rbt_node into rbt_tree. you can just call insert_rbt 
//(3) return created rbt_node
